...
public class ProdutoController {
	...
	public ModelAndView gravar(MultipartFile sumario, @Valid Produto produto, BindingResult bindingResult,
		...
		String path = this.fileSaver.salvar("arquivos-sumario", sumario);
	...
	public ModelAndView detalhe(@PathVariable("id")Integer produtoId){
	...
	public String trataProdutoNaoEncontrado(){
